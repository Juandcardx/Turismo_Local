...
public class PanelLogin extends JPanel
{
    ...
    public PanelLogin()
    {
        ...
        lbImagen.setBounds(540,10,150,100);
        add(lbImagen);

        iImagen = new ImageIcon("ultima.png");
        lbImagen = new JLabel(iImagen);
        lbImagen.setBounds(-140,330,1000,100);
        add(lbImagen);
        ...
        lbTituloLogin.setBounds(0, 125, 720, 30);
        ...
        lbUsuarioLogin.setBounds(-135, 190, 540, 30);
        ...
        lbContraseñaLogin.setBounds(-115, 230, 540, 30);
        ...
        tfUsuarioLogin.setBounds(265, 190, 200, 30);
        ...
        pfContraseñaLogin.setBounds(265, 230, 200, 30);
        ...
        btnAccionLogin.setBounds(510, 190, 180, 30);
        ...
        btnDialogo.setBounds(510, 230, 180, 30);
        btnDialogo.setActionCommand("crearRegistro");

        this.setLayout(null);
        this.setBackground(Color.decode("#42855B"));
